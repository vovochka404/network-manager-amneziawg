...
gchar *awg_device_dup_private_key(AWGDevice *self);
const gchar *awg_device_get_public_key(AWGDevice *self);
gchar *awg_device_dup_public_key(AWGDevice *self);
...
guint16 awg_device_get_fw_mark(AWGDevice *self);
...
guint32 awg_device_get_h1(AWGDevice *self);
guint32 awg_device_get_h2(AWGDevice *self);
guint32 awg_device_get_h3(AWGDevice *self);
guint32 awg_device_get_h4(AWGDevice *self);
...
gboolean awg_device_set_h1(AWGDevice *self, guint64 h1);
gboolean awg_device_set_h1_from_string(AWGDevice *self, const gchar *str);
gboolean awg_device_set_h2(AWGDevice *self, guint64 h2);
gboolean awg_device_set_h2_from_string(AWGDevice *self, const gchar *str);
gboolean awg_device_set_h3(AWGDevice *self, guint64 h3);
gboolean awg_device_set_h3_from_string(AWGDevice *self, const gchar *str);
gboolean awg_device_set_h4(AWGDevice *self, guint64 h4);
gboolean awg_device_set_h4_from_string(AWGDevice *self, const gchar *str);
...
gchar *awg_device_peer_dup_public_key(AWGDevicePeer *self);
const gchar *awg_device_peer_get_shared_key(AWGDevicePeer *self);
gchar *awg_device_peer_dup_shared_key(AWGDevicePeer *self);
